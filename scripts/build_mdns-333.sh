...
export ST="true"
export STRIP="echo not striping "
...
patch ../Clients/Makefile ../../../MakeFile-mDNSResponder-client-333.patch

echo "[*] Current working dir is ${PWD} runing make"
make  CC="${CC}" RANLIB="${RANLIB}" LD="${LD}" ST="${ST}" CFLAGS="${CFLAGS}" os="linux" STRIP="echo not STRIPING"
